...
<a data-toggle="modal" href="#talkronaldo" type="button" class="btn btn-primary">TALK</a>
...
<a data-toggle="modal" href="#talkdhoni" type="button" class="btn btn-primary">TALK</a>
</div>
<div class="panel-body">
...
<div class="main-content no-pad">
<div class="col-md-12">
<h3>Ask Any Query To Virat <span class="pull-right">17</span></h3>
...
<a data-toggle="modal" href="#talkkohli" type="button" class="btn btn-primary">TALK</a>
<div class="panel-body">
...
<form class="form-horizontal" role="form" method="get" action = "#" onSubmit = "return validate(this)">
  ...
  <div class="form-group">
   <div class="col-md-1"></div>
    <div class="col-md-10">
      <a type="button" data-toggle="modal" href="#success" class="btn btn-primary" onsubmit="return checkForm(this);">Submit</a>
    </div>
  </div>
  <div class="form-group">
    <div class="col-md-1"></div>
