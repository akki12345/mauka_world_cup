       ...
       <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
           ...
           <img src="./cup/meme1.jpg" alt="...">            
            ...
            <div class="caption">
              <h5><a>Abe Mentos kha ke aa.</a></h5>
              <ul class="list-unstyled">
                 <li>#MaukaMaukaofficial</li>
              </ul>
            </div>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
           ...
           <img src="./cup/meme2.jpg" alt="...">            
            ...
            <div class="caption">
              <h5><a>Master Blaster Sachin</a></h5>
              <ul class="list-unstyled">
                <li>#MaukaMaukaofficial</li>
              </ul>
            </div>
      ...
      <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
           ...
           <img src="./cup/meme3.jpg" alt="...">            
            ...
            <div class="caption">
              <h5><a>Jhor lga ke haaai Sa..</a></h5>
              <ul class="list-unstyled">
                <li>#MaukaMaukaofficial</li>
              </ul>
            </div>
        ...
        <div class="col-sm-6 col-md-3">
          ...
          <div class="thumbnail">
           ...
           <img src="./cup/meme7.jpg" alt="...">            
            ...
            <div class="caption">
              <h5><a>Afridi tum sa na ho payega</a></h5>
              <ul class="list-unstyled">
                <li>#MaukaMaukaofficial</li>
              </ul>
            </div>
